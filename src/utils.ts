 ...
 */
export function createDocument<T>(data: T, id?: string, version?: DocumentVersion): Document<T> {
...
export function cloneDocument<T>(
  ...
  const finalTimestamp =
    timestamp <= document.version.timestamp ? document.version.timestamp + 1 : timestamp;
 ...
 */
export function simpleChecksum(data: unknown): string {
